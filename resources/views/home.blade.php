...
<head>
    ...
    <link rel="stylesheet" href="{{asset('fa/font-awesome/4.7.0/css/font-awesome.min.css')}}">
                        ...
                        <li>
                            <div class="dropdowns">
                                ...
                                <div class="dropdowns-content">
                                    @guest
                                    <a href="{{url('user/profil')}}">Profile</a>
            ...
            <div class="hero container">
                <div class="hero-copy">
                    ...
                    <div class="hero-buttons">
                        <a href="{{url('shop')}}" class="button button-white">Shop</a>
                        <a href="https://instagram.com/kopigucialitproduk" class="button button-white">Official Ig</a>
                    </div>
                </div> <!-- end hero-copy -->

                <div class="hero-image">
                    <img src="{{asset('bg-icon.jpg')}}" width="440px" alt="hero image">
                </div> <!-- end hero-image -->
            </div> <!-- end hero -->
        </header>
        ...
        <div class="blog-section">
            <div class="container">
                ...
                <div class="blog-posts text-center">
                    <div class="blog-post">
                        <img src="{{asset('bg-icon.jpg')}}" width="350px" alt="title-image">
                    ...
                    <div class="blog-post">
                        <img src="{{asset('icon-coffee.jpg')}}" width="350px" alt="title-image">
