...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header"> <?php echo e(isset($url) ? ucwords($url) : ""); ?> <?php echo e(__('Register')); ?></div>
                ...
                <div class="card-body">
                    ...
                    <?php endif; ?>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="address" type="text" class="form-control<?php echo e($errors->has('name') ? ' is-invalid' : ''); ?>" name="address" value="<?php echo e(old('address')); ?>" required autofocus>
