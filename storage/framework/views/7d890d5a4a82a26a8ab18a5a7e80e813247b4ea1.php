        ...
        <nav class="main-header navbar navbar-expand bg-white navbar-light border-bottom">
            <ul class="navbar-nav">
                ...
                <li class="nav-item d-none d-sm-inline-block">
                    <a href="<?php echo e(route('homeadmin')); ?>" class="nav-link">Home</a>
                </li>
                <li class="nav-item d-none d-sm-inline-block">
...
​
        <?php echo $__env->make('layouts.module.sidebar', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
​
        <?php echo $__env->yieldContent('content'); ?>
        
        <?php echo $__env->make('layouts.module.footer', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
    </div>
​
    <!-- jQuery -->
